...
export function StreamersTable({ 
  ...
  const copyStreamerData = (streamer: Streamer, index: number) => {
    ...
    const text = `🏆 ${index + 1} ${streamer.name} ${streamer.streamer_id} ${formatNumber(streamer.luck_gifts)} ${formatNumber(streamer.exclusive_gifts)} ${formatNumber(streamer.host_crystals)} ${formatCurrency(hostUsd)} ${formatCurrency(agencyUsd)} ${formatNumber(streamer.minutes)}min ${hours} ${streamer.effective_days}`;
        ...
        <Table>
          <TableHeader>
            <TableRow className="bg-muted/30">
              ...
              <SortableHeader field="minutes" className="text-right">Minutos</SortableHeader>
            ...
            {paginatedStreamers.map((streamer, index) => {
              ...
              return (
                <TableRow key={streamer.id} className="hover:bg-muted/20">
                  ...
                  <TableCell className="text-right">{formatNumber(streamer.minutes)}</TableCell>
